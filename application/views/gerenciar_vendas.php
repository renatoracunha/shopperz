		...
		function abrirModal(voucher_id) {
			$.ajax({
				...
				success: function(data) {
					...
					$('#enderecoModal').html('');
					$('#enderecoModal').html(data.endereco);
					$('#telefoneModal').html('');
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<center><strong>Endereço do Comprador: <span id="enderecoModal"></span></strong></center><br>
					<center><strong>Telefone: <span id="telefoneModal"></span></strong></center><br>
					<strong>Itens: <span id="itens"></span></strong><br>
					<div style="border-top: 2px solid  black" class="text-right">
						<strong>Valor Total: <span id="valor_total"></span></strong><br>
					</div>
				</div>
